...
motor left_armMotorA = motor(PORT2, ratio36_1, false);
motor left_armMotorB = motor(PORT9, ratio36_1, false);
motor_group left_arm = motor_group(left_armMotorA, left_armMotorB);
motor right_armMotorA = motor(PORT3, ratio36_1, true);
motor right_armMotorB = motor(PORT1, ratio36_1, true);
